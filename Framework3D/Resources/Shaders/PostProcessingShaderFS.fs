...
const vec3 uLift = vec3(0.0);
const vec3 uGamma = vec3(0.0);
const vec3 uGain = vec3(0.0);
const vec3 uOffset = vec3(0.0);
const float uContrast = 1.0;
const float uContrastPivot = 0.5;
const float uSaturation = 1.0;
const float uHue = 0.0;
const float uTemperature = 66.0;
const float uUnsharpMask = 0.0;
const vec2 uResolution = vec2(540.0,720.0);
